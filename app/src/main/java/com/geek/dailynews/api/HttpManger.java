...
import com.geek.dailynews.utils.NetWorkUtils;
...
public class HttpManger {
    ...
    private static SparseArray<HttpManger> sRetrofitManager = new SparseArray<>(HostType.TYPE_COUNT);
...
/*
   1. noCache 不使用缓存，全部走网络
    ...
    //构造方法私有
    private HttpManger(int hostType) {
        //开启Log
    ...
    public static ApiService getDefault(int hostType) {
        HttpManger retrofitManager = sRetrofitManager.get(hostType);
        if (retrofitManager == null) {
            retrofitManager = new HttpManger(hostType);
