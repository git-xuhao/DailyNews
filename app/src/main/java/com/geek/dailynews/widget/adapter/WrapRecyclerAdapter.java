package com.geek.dailynews.widget.adapter;
 ...
 * 可添加头部或者底部的RecyclerView Adapter
 */
...
public class WrapRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
     ...
     * for each mapping.
     */
    //由上面的官方的注释可以看出比Map要高效一些，用来存放头部和底部的view
    private SparseArray<View> mHeaderViews;
    private SparseArray<View> mFooterViews;


    // 基本的头部类型开始位置  用于viewType
    private static int BASE_ITEM_TYPE_HEADER = 0x111;
    // 基本的底部类型开始位置  用于viewType
    private static int BASE_ITEM_TYPE_FOOTER = 0x222;
