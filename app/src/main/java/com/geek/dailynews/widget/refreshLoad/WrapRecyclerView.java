...
import com.geek.dailynews.widget.adapter.OnItemClickListener;
import com.geek.dailynews.widget.adapter.OnLongGeekClickListener;
import com.geek.dailynews.widget.adapter.WrapRecyclerAdapter;
...
public class WrapRecyclerView extends RecyclerView {
    ...
    private AdapterDataObserver mDataObserver = new AdapterDataObserver() {
        ...
        public void onItemRangeMoved(int fromPosition, int toPosition, int itemCount) {
            if (mAdapter == null) return;
            // 列表Adapter更新 包裹的也需要更新不然列表的notifyItemMoved没效果
            if (mWrapRecyclerAdapter != mAdapter)
    ...
    public OnLongGeekClickListener mLongClickListener;
    ...
    public void setOnLongClickListener(OnLongGeekClickListener longClickListener) {
